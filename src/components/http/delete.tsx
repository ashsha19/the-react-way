...
export interface IHttpDeleteProps extends IInternalComponentProps {
    endpoint: string;
...
export function HttpDelete(props: IHttpDeleteProps) {
    ...
    hooks.ue((props: IHttpDeleteProps) => {
        // React.useEffect(() => {
